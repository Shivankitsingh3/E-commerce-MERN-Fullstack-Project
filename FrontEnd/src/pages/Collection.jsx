...
const Collection = () => {
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 pt-4 sm:gap-10 border-t'>
      ...
      <div className="flex-1">
        ...
        <div className="flex justify-between text-base sm:text-2xl mb-4">
          ...
          <select onChange={(e) => setSortType(e.target.value)} id="" className="border-2 border-gray-300 text-sm px-2">
